...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if ($user_id == 0) {
        ...
        $conn->query("
            ...
            VALUES ('$full_name','$email','patient','active')
        ");
        ...
        // create patient
        $conn->query("
            INSERT INTO patients (user_id,gender,age,contact,address)
            VALUES ($new_id,'$gender','$age','$contact','$address')
        ");
...
if (isset($_GET['edit'])) {
    ...
    $res = $conn->query("
        SELECT u.user_id,u.full_name,u.email,
               p.gender,p.age,p.contact,p.address
        FROM users u
...
.gender-stat-card.male i { color: #3b82f6; }
.gender-stat-card.female i { color: #ec489a; }
.gender-stat-card.other i { color: #8b5cf6; }
.gender-stat-card .count {
  font-family: 'Fraunces', serif;
  font-size: 36px;
  font-weight: 700;
  color: var(--text-1);
...
.gender-stats-row { animation: riseUp 0.4s 0.1s ease both; }
.form-card, .table-card { animation: riseUp 0.4s 0.15s ease both; }

@media (max-width: 1200px) {
  .float-cards-row { flex-wrap: wrap; }
  .gender-stats-row { flex-wrap: wrap; }
}
...
<aside class="sidebar">
  ...
  <nav class="sb-nav">
    ...
    <a href="adminpharmacists.php" class="sb-link">
      <span class="sb-icon"><i class="fa-solid fa-pills"></i></span> Pharmacists
    </a>

    <div class="sb-section-label">Hospital</div>

    <a href="adminpatients.php" class="sb-link active">
      <span class="sb-icon"><i class="fa-solid fa-users"></i></span> Patients
    </a>

    <a href="adminappointments.php" class="sb-link">
      <span class="sb-icon"><i class="fa-solid fa-calendar-check"></i></span> Appointments
    </a>
    ...
    <a href="adminprofile.php" class="sb-link">
      <span class="sb-icon"><i class="fa-solid fa-user-gear"></i></span> Profile
    </a>

    <a href="adminsettings.php" class="sb-link">
      <span class="sb-icon"><i class="fa-solid fa-gears"></i></span> Settings
    </a>
  </nav>
...
<div class="main">
  ...
  <header class="topbar">
    ...
    <nav class="topbar-nav">
      ...
      <a href="adminpatients.php" class="active">
  ...
  <div class="content">
    ...
    <div class="float-cards-row">
      ...
      <div class="float-card">
        <div class="fc-icon-wrap"><i class="fa-solid fa-circle-question"></i></div>
        <div class="fc-label">Other</div>
    ...
    <div class="form-card">
      ...
      <div class="form-header">
        ...
        <h3><?= $edit ? "Edit Patient" : "Add New Patient" ?></h3>
      </div>
      ...
      <div class="form-body">
        ...
        <form method="POST">
          ...
          <button class="btn-submit">
            ...
            <?= $edit ? "Update Patient" : "Save Patient" ?>
          </button>
...
<td><?= htmlspecialchars($p['address'] ?? '') ?></td>
            <td>
              <div class="action-buttons">
                <a href="?edit=<?= $p['user_id'] ?>" class="btn-edit">Edit</a>
                <a href="?delete=<?= $p['user_id'] ?>" class="btn-delete"
