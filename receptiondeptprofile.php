...
<div class="page-wrap">
  ...
  <a href="receptiondashboard.php" class="back-link"><i class="fas fa-arrow-left"></i> Back to Dashboard</a>
  ...
  <div class="card">
    <div class="profile-head">
      ...
      <div class="profile-head-text">
        ...
        <div class="role">Reception Department Head</div>
  ...
  <div class="card">
    ...
    <a href="receptiondeptchangepassword.php" class="btn-save" style="text-decoration:none;">
