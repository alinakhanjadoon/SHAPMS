<?php
session_start();
require_once "logger.php";   // ✅ ADD THIS
...
logAction(
    ...
    $_SESSION['user_id'],
    $_SESSION['role'],
    "Patient viewed prescriptions page"
);
...
<div class="container">
    ...
    <div class="stats-header">
        ...
        <div class="prescription-count">
            <i class="fas fa-file-alt"></i> Total: <?= $result->num_rows ?> Prescriptions
        </div>
    </div>
    ...
    <?php if ($result->num_rows === 0): ?>
        <div class="empty-state">
            ...
            <small>Prescriptions will appear here after your doctor prescribes medication</small>
        </div>
    <?php endif; ?>
        ...
        <div class="prescription-card">
            <div class="card-header">
                <div class="card-header-left">
                    ...
                    <h3>Prescription #<?= htmlspecialchars($row['prescription_id']) ?></h3>
                </div>
            ...
            <div class="card-body">
                <div class="info-grid">
                    <div class="info-item">
                        <div class="info-label"><i class="fas fa-calendar-alt"></i> Appointment Date</div>
                        <div class="info-value"><?= date("d M Y", strtotime($row['appointment_date'])) ?></div>
                    </div>
                    <div class="info-item">
                        <div class="info-label"><i class="fas fa-clock"></i> Issued On</div>
                        <div class="info-value"><?= date("d M Y", strtotime($row['created_at'])) ?></div>
                    </div>
                    <div class="info-item">
                        <div class="info-label"><i class="fas fa-user-md"></i> Prescribing Doctor</div>
                        <div class="info-value">Dr. <?= htmlspecialchars($row['doctor_name']) ?></div>
                    </div>
                </div>
                <div class="prescription-details">
                    <strong><i class="fas fa-notes-medical"></i> Prescription Details</strong>
                    <p><?= nl2br(htmlspecialchars($row['prescription_details'])) ?></p>
                </div>
            </div>
        </div>
    <?php endwhile; ?>
